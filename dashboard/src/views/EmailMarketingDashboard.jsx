          ...
          <div style={{ height: '350px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={mockChartData}>
                ...
                <Tooltip
                  contentStyle={{ backgroundColor: 'var(--color-card)', borderRadius: '12px', border: '1px solid var(--color-border)', boxShadow: 'var(--glass-shadow)', color: 'var(--color-text-primary)' }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div className="glass-panel" style={{ padding: '24px', flex: 1 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div style={{ padding: '16px', borderRadius: '12px', border: '1px solid var(--color-border)', background: 'rgba(255,255,255,0.05)' }}>
                ...
                <div style={{ display: 'flex', gap: '16px' }}>
                  <div><p style={{ fontSize: '10px', color: 'var(--color-text-secondary)' }}>Opens</p><p style={{ fontSize: '14px', fontWeight: '700' }}>1,240</p></div>
                  <div><p style={{ fontSize: '10px', color: 'var(--color-text-secondary)' }}>Clicks</p><p style={{ fontSize: '14px', fontWeight: '700' }}>280</p></div>
                  <div><p style={{ fontSize: '10px', color: 'var(--color-text-secondary)' }}>CTR</p><p style={{ fontSize: '14px', fontWeight: '700' }}>22.5%</p></div>
                </div>
              </div>

              <div style={{ padding: '16px', borderRadius: '12px', border: '1px solid var(--color-border)', background: 'rgba(255,255,255,0.02)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                  <span style={{ fontSize: '14px', fontWeight: '600' }}>Onboarding Series 1</span>
                  <span style={{ fontSize: '12px', color: 'var(--color-text-secondary)' }}>Completed</span>
                </div>
                <div style={{ display: 'flex', gap: '16px' }}>
                  <div><p style={{ fontSize: '10px', color: 'var(--color-text-secondary)' }}>Opens</p><p style={{ fontSize: '14px', fontWeight: '700', color: 'var(--color-text-secondary)' }}>890</p></div>
                  <div><p style={{ fontSize: '10px', color: 'var(--color-text-secondary)' }}>Clicks</p><p style={{ fontSize: '14px', fontWeight: '700', color: 'var(--color-text-secondary)' }}>115</p></div>
                  <div><p style={{ fontSize: '10px', color: 'var(--color-text-secondary)' }}>CTR</p><p style={{ fontSize: '14px', fontWeight: '700', color: 'var(--color-text-secondary)' }}>12.9%</p></div>
                </div>
              </div>
            </div>
          </div>

          <div style={{ background: 'linear-gradient(135deg, rgba(3,218,198,0.15) 0%, rgba(0,230,118,0.05) 100%)', padding: '24px', borderRadius: '16px', border: '1px solid var(--color-border-glow)' }}>
            <h4 style={{ fontSize: '16px', marginBottom: '12px', color: 'var(--color-dark-green)', fontWeight: 700 }}>Marketing Insight</h4>
