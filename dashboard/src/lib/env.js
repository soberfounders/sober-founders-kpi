...
export const DASHBOARD_LOOKBACK_DAYS = getBoundedInt('VITE_DASHBOARD_LOOKBACK_DAYS', 180, {
...
export const LEADS_LOOKBACK_DAYS = getBoundedInt('VITE_LEADS_LOOKBACK_DAYS', 180, {
  min: MIN_LOOKBACK_DAYS,
  max: MAX_LOOKBACK_DAYS,
});
...
export const ATTENDANCE_BACKFILL_DAYS = getBoundedInt('VITE_ATTENDANCE_BACKFILL_DAYS', 180, {
  min: MIN_LOOKBACK_DAYS,
  max: MAX_LOOKBACK_DAYS,
});
