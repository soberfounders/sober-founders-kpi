...
<div class="sf-home">
  ...
  <div style="max-width:1100px;margin:0 auto;padding:0 24px 60px;">
    <div class="sf-trust">
      ...
      <p><strong>Silver Transparency Seal</strong> &mdash; Sober Founders earned the highest seal a first-year nonprofit can achieve from Candid (formerly GuideStar), reflecting our commitment to openness and accountability.</p>
    </div>
  </div>
