    ...
    $schema = [
        ...
        '@graph' => [
            ...
            [
                '@type' => 'FAQPage',
                'mainEntity' => [
                    ['@type' => 'Question', 'name' => 'What is the Phoenix Forum?', 'acceptedAnswer' => ['@type' => 'Answer', 'text' => 'The Phoenix Forum is a curated peer advisory group (maximum 10 members per group) operated by Sober Founders, a 501(c)(3) nonprofit. It is designed for entrepreneurs with $1M+ in annual revenue and more than one year of sobriety. Members participate in a monthly "hot seat" (essentially a 4th and 5th step on their businesses and lives).']],
                    ...
                    ['@type' => 'Question', 'name' => 'How much does the Phoenix Forum cost?', 'acceptedAnswer' => ['@type' => 'Answer', 'text' => 'The Phoenix Forum costs $499/mo. Contact the Sober Founders team via the application page to apply.']],
